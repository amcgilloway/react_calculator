  ...
  return (
    <div className="buttons">
        ...
        <div className="two">
          ...
          <button id="operator_divide" onClick={() => operatorClick('/')}>/</button>
          ...
          <button id="operator_multiply" onClick={() => operatorClick('*')}>x</button>
          ...
          <button id="operator_subtract" onClick={() => operatorClick('-')}>-</button>
